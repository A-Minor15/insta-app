...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="row mb-4">
            <div class="col-6">
                ...
                <img src="<?php echo e(old('image', $post->image)); ?>" alt="post id <?php echo e($post->id); ?>" class="img-thumbnail w-100">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\degtj\OneDrive\デスクトップ\laravel-insta\insta-app\resources\views/users/posts/edit.blade.php ENDPATH**/ ?>
<div class="row">
    ...
    <div class="col-8">
        ...
        <div class="row mb-3">
            <div class="col-auto">
                <a href="<?php echo e(route('post.show', $user->id)); ?>" class="text-decoration-none text-dark">
            ...
            <div class="col-auto">
                <a href="<?php echo e(route('profile.followers', $user->id)); ?>" class="text-decoration-none text-dark">
                    <strong><?php echo e($user->follower->count()); ?></strong> <?php echo e($user->follower->count() == 1 ? 'Follower':'Followers'); ?>
...
<?php /**PATH C:\Users\degtj\OneDrive\デスクトップ\laravel-insta\insta-app\resources\views/users/profile/header.blade.php ENDPATH**/ ?>
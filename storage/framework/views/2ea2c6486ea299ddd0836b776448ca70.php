        ...
        <ul class="list-group mt-2">
            <?php $__currentLoopData = $post->comments->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="list-group-item border-0 p-0 mb-2">
                    <a href="<?php echo e(route('profile.show', $comment->user->id)); ?>" class="text-decoration-none text-dark fw-bold"><?php echo e($post->user->name); ?></a>
                    &nbsp;
                    <div class="d-inline fw-light"><?php echo e($comment->body); ?></div>
                    <form action="<?php echo e(route('comment.destroy', $comment->id)); ?>" method="post">
                        ...
                        <?php if(Auth::user()->id === $post->user->id): ?>
                            &middot;<button type="submit" class="text-danger border-0 bg-transparent p-0 xsmall">Delete</button>
                        <?php endif; ?>
                    </form>
                </li>
...
<?php /**PATH C:\Users\degtj\OneDrive\デスクトップ\laravel-insta\insta-app\resources\views/users/posts/contents/comments.blade.php ENDPATH**/ ?>
                                ...
                                <?php $__currentLoopData = $post->comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="list-group-item border-0 p-0 mb-2">
                                        ...
                                        <form action="<?php echo e(route('comment.destroy', $comment->id)); ?>" method="post">
                                            ...
                                            <p class="xsmall text-danger">Posted on <?php echo e($comment->created_at->diffForHumans()); ?></p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\degtj\OneDrive\デスクトップ\laravel-insta\insta-app\resources\views/users/posts/show.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container mb-2 pe-0">
        <div class="row justify-content-end">
            <div class="col-auto">
                <form action="<?php echo e(route('admin.users')); ?>" method="get" class="float-end">
                    <input type="search" name="search" id="search" class="search form-control form-control-sm" value="<?php echo e($search); ?>" placeholder="search for names...">
                </form>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\degtj\OneDrive\デスクトップ\laravel-insta\insta-app\resources\views/admin/users/index.blade.php ENDPATH**/ ?>